...
data2=data2[data2$sex=="Male",]
data2=data2[data2$classwkrd=="Self-employed, incorporated"|data2$classwkrd=="Self-employed, not incorporated",]
...
+as.factor(time)+as.factor(group1)+time:group1,data=data2)
