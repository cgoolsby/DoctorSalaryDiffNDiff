...
"Missouri","Wisconsin","Vermont","Washington","Alabama","Arizona","Illinois","Idaho","Kansas","Mississippi","Nebraska","Oklahoma","South Carolina","South Dakota","Utah","Wyoming"),]
...
data1$time=as.numeric(data1$year)
