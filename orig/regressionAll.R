...
png('regressionAll.png')
plot(comparison1[,1],comparison1[,2],type="l",ylim=c(184000,250000),col="blue",xlab="year",ylab="Mean income", xaxp=c(2008,2016, 8))
#plot(comparison1[,1],comparison1[,2],type="l",col="blue",xlab="year",ylab="Mean income", xaxp=c(2008, 2016, 8), ylim=c(184000, 277777770000)
abline(v=c(2012, 2014), col=c("black"), lty=c(1,2), lwd=c(1))
